...
def update_metric(api_key, metric_id, name=None, description=None, 
                 ...
                 display_order=None):
    url = f'https://new-prod.vocera.ai/test_framework/v1/metrics-external/{metric_id}/'
...
async function updateMetric(apiKey, metricId, {
  ...
  const url = `https://new-prod.vocera.ai/test_framework/v1/metrics-external/${metricId}/`;
